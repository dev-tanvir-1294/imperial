  ...
  return (
    <div className="bg-white dark:bg-black py-3 border-t">
        <div className="container my-0 mx-auto flex flex-col sm:flex-row justify-between items-center sm:items-start gap-5">
            ...
            <div>
                <ul className="flex flex-col sm:flex-row justify-between items-center sm:items-start gap-5 text-xl">
            ...
            <div className="flex flex-row gap-5 justify-center items-center text-xl">
